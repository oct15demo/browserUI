...
The main components of the Knime application and this setup, aside from the Knime SDK, are org.knime.base and org.knime.core. Additionally, org.knime.js.core and org.knime.js.views are incorporated into the base project as a convenient shortcut instead of being set up as their own projects. They are needed to  display the output of workflows in the browser.  js.views is a component of Knime Labs, meaning it is an additional package not yet included in the standard distribution.  
...
Follow the directions below to retrieve the code from the Knime repo. Those directions will leave you with the necessary Knime code in Eclipse, before any additions and modifications have been made that are necessary for the browser UI.    
